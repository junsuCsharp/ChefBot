...
namespace CSharpWPFCharts
{
    public class surfaceaxis : DemoModule
    {
        ...
        public void createChart(WPFChartViewer viewer, int chartIndex)
        {
            ...
            DateTime[] dataX = {new DateTime(2008, 9, 1), new DateTime(2008, 9, 2), new DateTime(
                2008, 9, 3), new DateTime(2008, 9, 4), new DateTime(2008, 9, 5), new DateTime(2008,
                9, 6)};
            ...
            // Add a color axis (the legend) in which the top right corner is anchored at (95, 100).
            // Set the length to 160 pixels and the labels on the left side.
