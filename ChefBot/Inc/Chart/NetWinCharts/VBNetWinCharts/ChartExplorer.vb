...
Public Class ChartExplorer
    ...
    Private Sub ChartExplorer_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim angularMeterNode As TreeNode = New TreeNode("Angular Meters/Gauges")
        ...
        Dim linearMeterNode As TreeNode = New TreeNode("Linear Meters/Gauges")
        ...
        Dim barMeterNode As TreeNode = New TreeNode("Bar Meters/Gauges")
