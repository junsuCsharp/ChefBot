...
{
    public class HboxwhiskerModel : PageModel
    {
        public void OnGet()
        {
            ViewData["Title"] = "Horizontal Box-Whisker Chart";
        ...
        private void createChart(RazorChartViewer viewer)
        {
            ...
            string[] labels = {"<*img=@/Images/robot1.png*><*br*>Bipedal Type",
                "<*img=@/Images/robot2.png*><*br*>Wolf Type",
                "<*img=@/Images/robot5.png*><*br*>Bird Type"};
