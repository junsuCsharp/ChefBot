...
{
    public class ClickpieModel : PageModel
    {
        public void OnGet()
        {
            ViewData["Title"] = "Simple Clickable Pie Chart";
        ...
        private void createChart(RazorChartViewer viewer)
        {
            ...
            int selectedYear = int.Parse(Request.Query["year"].ToString());
            int selectedMonth = int.Parse(Request.Query["x"].ToString()) + 1;
            ...
            viewer.ImageMap = c.getHTMLImageMap(Url.Page("", "", "Piestub"), "",
