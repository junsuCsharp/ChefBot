...
{
    public class ClicklineModel : PageModel
    {
        public void OnGet()
        {
            ViewData["Title"] = "Simple Clickable Line Chart";
        ...
        private void createChart(RazorChartViewer viewer)
        {
            ...
            string selectedYear = Request.Query["xLabel"].ToString();
            ...
            viewer.ImageMap = c.getHTMLImageMap(Url.Page("Clickpie", "", new { year = selectedYear }),
