...
{
    public class CandlestickModel : PageModel
    {
        public void OnGet()
        {
            ViewData["Title"] = "Simple Candlestick Chart";
        ...
        private void createChart(RazorChartViewer viewer)
        {
            ...
            // Add a CandleStick layer to the chart using green (00ff00) for up candles and red (ff0000)
            // for down candles
