...
{
    public class RealtimesnapshotModel : PageModel
    {
        //
        // Draw the chart
        //
        private void drawChart(RazorChartViewer viewer)
        {
            ...
            if (Request.Query["download"].ToString() == "pdf") {
        ...
        public IActionResult OnGet()
        {
            ...
            if (!string.IsNullOrEmpty(Request.Query["download"].ToString())) {
                return File(viewer.StreamChart(), Response.ContentType, "demo_" + DateTime.Now.ToString(
                    "yyyyMMddHHmmss") + "." + Request.Query["download"].ToString());
            }
