...
{
    public class Iconpie2Model : PageModel
    {
        public void OnGet()
        {
            ViewData["Title"] = "Icon Pie Chart (2)";
        ...
        private void createChart(RazorChartViewer viewer)
        {
            ...
            string[] icons = {"@/Images/laugh.png", "@/Images/smile.png", "@/Images/sad.png",
                "@/Images/angry.png", "@/Images/nocomment.png"};
            ...
            // effect
            c.addTitle(
                "<*block,valign=absmiddle*><*img=@/Images/doc.png*> Customer Survey: <*font=Times New " +
                "Roman Italic,color=000000*>Do you like our <*font,color=dd0000*>Hyper<*super*>TM" +
                "<*/font*> molecules?", "Times New Roman Bold Italic", 15, 0x000080).setBackground(
                0xa0c8ff, 0x000000, Chart.glassEffect());

            // Add a logo to the chart written in CDML as the bottom title aligned to the bottom right
            c.addTitle2(Chart.BottomRight,
                "<*block,valign=absmiddle*><*img=@/Images/molecule.png*> <*block*><*color=FF*>" +
