...
{
    public class ViewportcontroldemoModel : PageModel
    {
        //
        ...
        public IActionResult OnGet()
        {
            ...
            RazorViewPortControl viewPortCtrl = new RazorViewPortControl(HttpContext, "chart2");
            ViewData["ViewPortControl"] = viewPortCtrl;
