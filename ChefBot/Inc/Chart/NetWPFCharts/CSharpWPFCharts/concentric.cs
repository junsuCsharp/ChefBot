...
namespace CSharpWPFCharts
{
    public class concentric : DemoModule
    {
        ...
        public void createChart(WPFChartViewer viewer, int chartIndex)
        {
            ...
            //
            // Create the main chart, which contains the chart title, the outer ring, and the legend
            // box
            //
            ...
            // Add a label at the bottom-right corner of the ring to label the outer ring Use 12pt
            // Arial Bold Italic font in white (ffffff) color, on a green (008800) background, with
            ...
            // Add a label at the center of the ring to label the inner ring. Use 12pt Arial Bold
