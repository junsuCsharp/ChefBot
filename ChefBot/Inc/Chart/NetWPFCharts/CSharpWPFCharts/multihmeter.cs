...
{
    public class multihmeter : DemoModule
    {
        //Name of demo module
        public string getName() { return "Multi-Pointer Horizontal Meter"; }
        ...
        public void createChart(WPFChartViewer viewer, int chartIndex)
        {
            ...
            // Create an LinearMeter object of size 250 x 75 pixels, using silver background with a
