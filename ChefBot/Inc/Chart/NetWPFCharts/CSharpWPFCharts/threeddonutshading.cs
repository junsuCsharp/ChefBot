...
{
    public class threeddonutshading : DemoModule
    {
        //Name of demo module
        public string getName() { return "3D Donut Shading"; }
        ...
        public void createChart(WPFChartViewer viewer, int chartIndex)
        {
            ...
            // Create a PieChart object of size 200 x 200 pixels. Use a vertical gradient color from
