...
namespace CSharpWPFCharts
{
    public class stackedarea : DemoModule
    {
        ...
        public void createChart(WPFChartViewer viewer, int chartIndex)
        {
            ...
            // Add a legend box at (50, 185) (below of plot area) using horizontal layout. Use 8pt
            // Arial font with Transparent background.
            c.addLegend(50, 185, false, "", 8).setBackground(Chart.Transparent);

            // Add a title box to the chart using 8pt Arial Bold font, with yellow (0xffff40)
