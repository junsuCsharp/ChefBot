...
namespace CSharpWPFCharts
{
    public class unevenpoints : DemoModule
    {
        ...
        public void createChart(WPFChartViewer viewer, int chartIndex)
        {
            ...
            DateTime[] data0X = {new DateTime(2007, 1, 1), new DateTime(2007, 1, 2), new DateTime(
                2007, 1, 5), new DateTime(2007, 1, 7), new DateTime(2007, 1, 10), new DateTime(2007,
                1, 14), new DateTime(2007, 1, 17), new DateTime(2007, 1, 18), new DateTime(2007, 1,
                19), new DateTime(2007, 1, 20), new DateTime(2007, 1, 21)};
            ...
            // Create a XYChart object of size 600 x 400 pixels. Use a vertical gradient color from
            ...
            c.addTitle("Product Line Order Backlog", "Times New Roman Bold Italic", 18).setMargin2(
                0, 0, 16, 0);

            // Set the plotarea at (60, 80) and of 510 x 275 pixels in size. Use transparent border
            ...
            // ChartDirector auto-scaling will use this as the guidelines when putting ticks on the
            // x-axis and y-axis.
