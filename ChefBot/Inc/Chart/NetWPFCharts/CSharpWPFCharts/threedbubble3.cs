...
{
    public class threedbubble3 : DemoModule
    {
        //Name of demo module
        public string getName() { return "3D Bubble Chart (3)"; }
        ...
        public void createChart(WPFChartViewer viewer, int chartIndex)
        {
            ...
            // Add a legend box at (70, 30) (top of the chart) with horizontal layout. Use 12pt
            ...
            // Add (dataX1, dataY1) as a scatter layer with blue (0000ff) spheres, where the sphere
