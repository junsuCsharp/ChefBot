...
namespace CSharpWPFCharts
{
    public class glassmultibar : DemoModule
    {
        ...
        public void createChart(WPFChartViewer viewer, int chartIndex)
        {
            ...
            // color from light blue (f9f9ff) to blue (6666ff) as background. Set border and grid
            // lines to white (ffffff).
            c.setPlotArea(50, 55, 440, 280, c.linearGradientColor(0, 55, 0, 335, 0xf9f9ff, 0x6666ff
                ), -1, 0xffffff, 0xffffff);

            // Add a legend box at (50, 28) using horizontal layout. Use 10pt Arial Bold as font,
