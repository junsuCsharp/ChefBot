...
{
    public class explodedpie : DemoModule
    {
        //Name of demo module
        public string getName() { return "Exploded Pie Chart"; }
        ...
        public void createChart(WPFChartViewer viewer, int chartIndex)
        {
            ...
            // Use a vertical gradient color from deep blue (000066) to blue (0000cc) as background.
            // Use rounded corners of 20 pixels radius. Enable soft drop shadow.
            ...
            // same as the sector color. Use soft lighting effect with light direction from right.
            // Use 8 pixels rounded corners.
            ...
            // Set the sector label format. The label is centered in a 110 pixels wide bounding box.
            // It consists of two lines. The first line is the sector name. The second line shows
