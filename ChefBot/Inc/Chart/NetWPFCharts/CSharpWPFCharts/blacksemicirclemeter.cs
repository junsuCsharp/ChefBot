...
{
    public class blacksemicirclemeter : DemoModule
    {
        //Name of demo module
        public string getName() { return "Black Semicircle Meters"; }
        ...
        public void createChart(WPFChartViewer viewer, int chartIndex)
        {
            ...
            // Add a black (0x000000) scale background of 148 pixels radius with a 10 pixel thick
            // silver border
