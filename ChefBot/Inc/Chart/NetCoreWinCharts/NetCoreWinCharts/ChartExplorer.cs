...
namespace CSharpChartExplorer
{
	...
	public partial class ChartExplorer : Form
	{
		...
		public ChartExplorer()
		{
			...
			TreeNode angularMeterNode = new TreeNode("Angular Meters/Gauges");
            ...
            TreeNode linearMeterNode = new TreeNode("Linear Meters/Gauges");
            ...
            TreeNode barMeterNode = new TreeNode("Bar Meters/Gauges");
		...
		/// <summary>
		/// Handlers for the ToolStrip Button Click event
		/// </summary>
		...
		private string getHelpPath()
		{
			...
			// We search various places for the help file.
			string[] placeToSearch = new string[]
			{
				"",					// the current folder
				"../../../../doc/",	// the doc folder relative to the "Debug" folder
				"../../../../../doc/",
				"../../",			// the project or solution folder relative to "Debug")
				"../../../",
				"../../../../"
			};
		...
		private void updateControls()
		{
			...
			forwardButton.Enabled = (lastHistoryIndex > currentHistoryIndex);
			nextButton.Enabled = (getNextChartNode(treeView.SelectedNode) != null);
			previousButton.Enabled = (getPrevChartNode(treeView.SelectedNode) != null);
			...
			if ((null != treeView.SelectedNode) && (null != treeView.SelectedNode.Tag))
			{
				...
				statusBarLabel.Text = " Module " + m.GetType().Name + ": " + m.getName();
			}
			else
				statusBarLabel.Text = "";
		}
