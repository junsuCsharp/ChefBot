namespace CSharpChartExplorer
{
    partial class ParamViewer
    {
        ...
        private void InitializeComponent()
        {
			...
			this.listView.Location = new System.Drawing.Point(8, 46);
			this.listView.Name = "listView";
			this.listView.Size = new System.Drawing.Size(304, 197);
			...
			// OKPB
			// 
			this.OKPB.Location = new System.Drawing.Point(124, 249);
			this.OKPB.Name = "OKPB";
			...
			this.label.Size = new System.Drawing.Size(304, 36);
			this.label.TabIndex = 2;
			this.label.Text = "In this demo program, we just display the information provided to the ClickHotSpo" +
    "t event handler. ";
			// 
			// ParamViewer
			// 
