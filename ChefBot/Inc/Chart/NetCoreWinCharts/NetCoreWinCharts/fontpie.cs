...
namespace CSharpChartExplorer
{
    public class fontpie : DemoModule
    {
        ...
        public void createChart(WinChartViewer viewer, int chartIndex)
        {
            ...
            // Add a legend box using Arial Bold Italic/11 points font. Use a pink marble pattern as
            // the background wallpaper, with a 1 pixel 3D border. The legend box is top-right
            ...
            // Use Arial/8pt/deep blue as label font for the 5th sector. Add a background box using
            // the sector fill color (SameAsMainColor), with a black (0x000000) edge and 2 pixel 3D
            // border.
            c.sector(4).setLabelStyle("Arial", 8, 0x000080).setBackground(Chart.SameAsMainColor,
                0x000000, 2);

            // Use Arial Italic/8pt/light red (0xff9999) as label font for the 6th sector. Add a
            ...
            // Use Times Bold Italic/8pt/deep green (0x008000) as label font for 7th sector. Add a
