...
{
    public class YzonecolorController : Controller
    {
        //
        // Default Action
        //
        ...
        private void createChart(RazorChartViewer viewer)
        {
            ...
            c.addTitle(
                "<*block,valign=absmiddle*><*img=@/Images/star.png*><*img=@/Images/star.png*> Y Zone " +
                "Color Demo <*img=@/Images/star.png*><*img=@/Images/star.png*><*/*>",
            ...
            c.addAreaLayer(data, c.yZoneColor(60, unchecked((int)0x8033ff33), unchecked((int)0x80ff3333))
                );

            // Add a custom CDML text at the bottom right of the plot area as the logo
            c.addText(475, 255,
                "<*block,valign=absmiddle*><*img=@/Images/small_molecule.png*> <*block*><*font=Times " +
            ...
            viewer.ImageMap = c.getHTMLImageMap("", "", "title='Hour {xLabel}: {value} KJ/liter'");
        }
    }
}
