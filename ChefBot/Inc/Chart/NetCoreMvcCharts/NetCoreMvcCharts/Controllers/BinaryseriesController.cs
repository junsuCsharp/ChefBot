...
{
    public class BinaryseriesController : Controller
    {
        //
        // Default Action
        //
        ...
        {
            ViewBag.Title = "Binary Data Series";
        ...
        private void createChart(RazorChartViewer viewer)
        {
            ...
            DateTime[] dataX = {new DateTime(2008, 7, 1, 0, 0, 0), new DateTime(2008, 7, 1, 2, 17, 2),
                new DateTime(2008, 7, 1, 8, 5, 30), new DateTime(2008, 7, 1, 10, 54, 10), new DateTime(
                2008, 7, 1, 15, 40, 0), new DateTime(2008, 7, 1, 18, 22, 20), new DateTime(2008, 7, 1,
                22, 17, 14), new DateTime(2008, 7, 2, 2, 55, 50), new DateTime(2008, 7, 2, 8, 17, 14),
                new DateTime(2008, 7, 2, 11, 55, 50), new DateTime(2008, 7, 2, 13, 17, 14), new DateTime(
                2008, 7, 2, 17, 55, 50), new DateTime(2008, 7, 2, 20, 17, 14), new DateTime(2008, 7, 3,
                0, 0, 0)};
            ...
            // pixels.
            ChartDirector.TextBox title = c.addTitle("Binary Data Series Demonstration", "Arial Bold", 10
                );
