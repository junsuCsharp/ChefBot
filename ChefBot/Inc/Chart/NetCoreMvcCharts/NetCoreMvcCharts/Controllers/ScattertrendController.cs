...
{
    public class ScattertrendController : Controller
    {
        //
        // Default Action
        //
        ...
        {
            ViewBag.Title = "Scatter Trend Chart";
        ...
        private void createChart(RazorChartViewer viewer)
        {
            ...
            ScatterLayer scatter2 = c.addScatterLayer(dataX1, dataY1, "Server BBB", Chart.TriangleSymbol,
                9, 0x6666ff);
