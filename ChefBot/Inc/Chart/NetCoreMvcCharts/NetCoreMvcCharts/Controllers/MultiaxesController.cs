...
{
    public class MultiaxesController : Controller
    {
        //
        // Default Action
        //
        ...
        private void createChart(RazorChartViewer viewer)
        {
            ...
            // pixels.
            ChartDirector.TextBox title = c.addTitle("Multiple Axes Demonstration", "Arial Bold Italic",
                15);
            ...
            // Add a line layer to for the second data set using green (00c0000) color, with a line width
            // of 2 pixels. Bind the layer to the secondary y-axis.
            LineLayer layer1 = c.addLineLayer(data1, 0x008000, "Load");
            layer1.setLineWidth(2);
            layer1.setUseYAxis2();

            // Add a line layer to for the third data set using blue (0000cc) color, with a line width of
            // 2 pixels. Bind the layer to the third y-axis.
            LineLayer layer2 = c.addLineLayer(data2, 0x0000cc, "Temperature");
            layer2.setLineWidth(2);
            layer2.setUseYAxis(leftAxis);

            // Add a line layer to for the fourth data set using purple (880088) color, with a line width
            // of 2 pixels. Bind the layer to the fourth y-axis.
