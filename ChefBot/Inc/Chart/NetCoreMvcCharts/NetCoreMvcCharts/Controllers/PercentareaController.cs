...
{
    public class PercentareaController : Controller
    {
        //
        // Default Action
        //
        ...
        {
            ViewBag.Title = "Percentage Area Chart";
        ...
        private void createChart(RazorChartViewer viewer)
        {
            ...
            DateTime[] labels = {new DateTime(1996, 1, 1), new DateTime(1996, 4, 1), new DateTime(1996,
                7, 1), new DateTime(1996, 10, 1), new DateTime(1997, 1, 1), new DateTime(1997, 4, 1),
                new DateTime(1997, 7, 1), new DateTime(1997, 10, 1), new DateTime(1998, 1, 1),
