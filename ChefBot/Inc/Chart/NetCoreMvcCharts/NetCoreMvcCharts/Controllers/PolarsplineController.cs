...
{
    public class PolarsplineController : Controller
    {
        //
        // Default Action
        //
        ...
        {
            ViewBag.Title = "Polar Spline Chart";
        ...
        private void createChart(RazorChartViewer viewer)
        {
            ...
            double[] angles0 = {0, 15, 30, 45, 60, 75, 90, 105, 120, 135, 150, 165, 180, 195, 210, 225,
            ...
            double[] angles1 = {0, 15, 30, 45, 60, 75, 90, 105, 120, 135, 150, 165, 180, 195, 210, 225,
                240, 255, 270, 285, 300, 315, 330, 345};
