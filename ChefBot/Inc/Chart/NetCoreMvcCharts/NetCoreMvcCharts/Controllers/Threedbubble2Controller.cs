...
{
    public class Threedbubble2Controller : Controller
    {
        //
        // Default Action
        //
        ...
        {
            ViewBag.Title = "3D Bubble Chart (2)";
        ...
        private void createChart(RazorChartViewer viewer)
        {
            ...
            c.addScatterLayer(dataX0, dataY0, "Technology AAA", Chart.GlassSphere2Shape, 15, 0xff3333
            ...
            c.addScatterLayer(dataX1, dataY1, "Technology BBB", Chart.GlassSphere2Shape, 15, 0x0000ff
