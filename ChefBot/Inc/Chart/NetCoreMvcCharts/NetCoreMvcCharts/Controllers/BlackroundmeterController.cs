...
{
    public class BlackroundmeterController : Controller
    {
        //
        // Default Action
        //
        ...
        {
            ViewBag.Title = "Black Round Meters";
        ...
        private void createChart(RazorChartViewer viewer, int chartIndex)
        {
            ...
            if (chartIndex == 0 || chartIndex == 2) {
                // Put the value label center aligned at (125, 232), using black (0x000000) 14pt Arial
                // font on a light blue (0x99ccff) background. Set box width to 50 pixels with 5 pixels
                // rounded corners.
