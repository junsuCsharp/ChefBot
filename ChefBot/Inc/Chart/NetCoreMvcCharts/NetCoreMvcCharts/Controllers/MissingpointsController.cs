...
{
    public class MissingpointsController : Controller
    {
        //
        // Default Action
        //
        ...
        {
            ViewBag.Title = "Missing Data Points";
        ...
        private void createChart(RazorChartViewer viewer)
        {
            ...
            layer0.addDataSet(data0, 0xff0000, "Quantum Computer").setDataSymbol(Chart.GlassSphere2Shape,
                11);
            layer0.setLineWidth(3);

            // Add the second line. The missing data will be represented by using dash lines to bridge
            // the gap
            LineLayer layer1 = c.addLineLayer2();
            layer1.addDataSet(data1, 0x00ff00, "Atom Synthesizer").setDataSymbol(Chart.GlassSphere2Shape,
                11);
            ...
            // from the left edge, just under the legend box, 16 pixels from the right edge, and 25
