...
{
    public class ScattersurfaceController : Controller
    {
        //
        // Default Action
        //
        ...
        {
            ViewBag.Title = "Scattered Data Surface Chart";
        ...
        private void createChart(RazorChartViewer viewer)
        {
            ...
            // Create a SurfaceChart object of size 680 x 550 pixels. Set background to brushed silver
            // and border to grey (888888). Set the top-left and bottom-right corners to rounded corners
            // with 20 pixels radius.
            ...
            // Set the center of the plot region at (290, 235), and set width x depth x height to 360 x
            // 360 x 180 pixels
            ...
            // Add a color axis (the legend) in which the top right corner is anchored at (660, 80). Set
